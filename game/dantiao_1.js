...
class Session {
    ...
    dt_desktop_status_notification(param) {
        (async () => {
            const { stage } = param;
    ...
    baijiale_reconnection_res(param) {
        console.log(param)
    }
...
const ws = new WebSocket(`ws://127.0.0.1:50001/`);
ws.on('open', function open() {
    new Session(ws, {phone: 18664790286, password: '123456'});
})